...
ibmcloud fn action delete sqlcloudfunction_as_python
ibmcloud fn action create sqlcloudfunction_as_python --timeout 300000 --kind python-jessie:3 ibmcloudsql_cloudfunction.zip

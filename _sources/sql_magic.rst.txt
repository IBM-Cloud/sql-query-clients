...
* :py:class:`.SQLBuilder` class: provides APIs to help constructing a complete SQL query without knowing the details about syntax specific to IBM Cloud SQL
...
* :meth:`.transform_sql`: the decorator that is applied on the :meth:`.SQLBuilder.print_sql` and :meth:`.SQLBuilder.format_` methods
...
A :class:`.SQLBuilder` class is also a :class:`.TimeSeriesSchema` class.

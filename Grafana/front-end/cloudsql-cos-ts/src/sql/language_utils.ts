...
function addLabelsToExpression(expr: string, invalidLabelsRegexp: RegExp): string {
 ...
 */
export function fixSummariesMetadata(metadata: CloudSQLMetricsMetadata): CloudSQLMetricsMetadata {
  if (!metadata) {
    return metadata;
  }
